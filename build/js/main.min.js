...
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");
/* harmony import */ var _modules_init_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-slider */ "./js/modules/init-slider.js");
...
/* harmony import */ var _modules_tabs_dropdown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/tabs-dropdown */ "./js/modules/tabs-dropdown.js");
/* harmony import */ var _modules_table_toggle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/table-toggle */ "./js/modules/table-toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menu__WEBPACK_IMPORTED_MODULE_3__["menu"])();
  Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_5__["initSlider"])();
  Object(_modules_tabs_dropdown__WEBPACK_IMPORTED_MODULE_8__["tabsDropdown"])();
  Object(_modules_table_toggle__WEBPACK_IMPORTED_MODULE_9__["tableToggle"])();
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_accordion__WEBPACK_IMPORTED_MODULE_7__["initAccordions"])();
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_2__["initFormValidate"])();
    Object(_modules_video__WEBPACK_IMPORTED_MODULE_4__["initVideo"])();
  });
});
...
/* harmony import */ var _slider_default__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider-default */ "./js/modules/slider-default.js");
/* harmony import */ var _slider_mobile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider-mobile */ "./js/modules/slider-mobile.js");
/* harmony import */ var _slider_perview_two__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider-perview-two */ "./js/modules/slider-perview-two.js");



var sliderContainers = document.querySelectorAll('[data-slider]');
var initSetupSwiper = function initSetupSwiper(type, container) {
  switch (type) {
    case 'init-mobile':
      Object(_slider_mobile__WEBPACK_IMPORTED_MODULE_1__["initMobileSlider"])(container);
      break;
    case 'init-mobile-perview-two':
      Object(_slider_perview_two__WEBPACK_IMPORTED_MODULE_2__["initSliderPerviewTwo"])(container);
      break;
    default:
      Object(_slider_default__WEBPACK_IMPORTED_MODULE_0__["initDefaultSlider"])(container);
  }
};
var initSlider = function initSlider() {
  sliderContainers.forEach(function (it) {
    var type = it.dataset.slider;
...
var menu = function menu() {
  if (document.querySelector('.main-nav')) {
    ...
    var toggle = header.querySelector('.main-nav__toggle');
...
var showMenu = function showMenu(header, nav) {
  header.classList.add('is-opened');
  nav.classList.add('is-opened');
  document.body.classList.add('scroll-lock');
};
var hideMenu = function hideMenu(header, nav) {
...
/*!**************************************!*\
  !*** ./js/modules/slider-default.js ***!
  \**************************************/
/*! exports provided: initDefaultSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDefaultSlider", function() { return initDefaultSlider; });
var initDefaultSlider = function initDefaultSlider(container) {
...
/*!*************************************!*\
  !*** ./js/modules/slider-mobile.js ***!
  \*************************************/
/*! exports provided: initMobileSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMobileSlider", function() { return initMobileSlider; });
var initMobileSlider = function initMobileSlider(container) {
...
/*!******************************************!*\
  !*** ./js/modules/slider-perview-two.js ***!
  \******************************************/
/*! exports provided: initSliderPerviewTwo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSliderPerviewTwo", function() { return initSliderPerviewTwo; });
var initSliderPerviewTwo = function initSliderPerviewTwo(container) {
  var breakpoint = window.matchMedia('(max-width:767px)');
  var newsSlider;
  var settings = {
    autoHeight: true,
...
/*!************************************!*\
  !*** ./js/modules/table-toggle.js ***!
  \************************************/
/*! exports provided: tableToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tableToggle", function() { return tableToggle; });
var tableToggle = function tableToggle() {
  var tables = document.querySelectorAll('[data-table]');
  if (!tables) {
    return;
  }
  tables.forEach(function (table) {
    var btns = table.querySelectorAll('.table-control');
    var prev = table.querySelector('.table-control--prev');
    var next = table.querySelector('.table-control--next');
...
/*!*************************************!*\
  !*** ./js/modules/tabs-dropdown.js ***!
  \*************************************/
/*! exports provided: tabsDropdown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabsDropdown", function() { return tabsDropdown; });
var tabsDropdown = function tabsDropdown() {
  var dropTabs = document.querySelector('.droptabs');
  if (dropTabs) {
    var tabBtns = dropTabs.querySelectorAll('.droptabs__control');
    var tabContents = dropTabs.querySelectorAll('.droptabs__element');
    var trigger = dropTabs.querySelector('.droptabs__trigger');
    var dropdown = dropTabs.querySelector('.droptabs__dropdown');
    tabBtns.forEach(function (element) {
      element.addEventListener('click', function () {
        var index = Array.prototype.slice.call(tabBtns).indexOf(element);
...
/* harmony import */ var _utils_create_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/create-element */ "./js/utils/create-element.js");
